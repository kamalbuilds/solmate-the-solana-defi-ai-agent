# DeFi agents that can interact with and manage positions across Solana DeFi protocols, such as lending/borrowing, perps trading, and staking.
...
AI agents to launch & manage token liquidity — covering the token lifecycle: from fair token launches to liquidity provision (and locking), and stake-to-earn mechanisms.
